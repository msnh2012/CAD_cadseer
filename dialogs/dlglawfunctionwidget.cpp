...
//     }
  ...
  public:
    ...
    {
      //this makes the graphics scene take maximum space.
      QSizePolicy gvp = sizePolicy();
      gvp.setVerticalStretch(1);
      setSizePolicy(gvp);
...
bool LawFunctionWidget::hasStructureChanged()
{
  return stow->structureChanged;
}
...
void LawFunctionWidget::buildGui()
{
  ...
  stow->mainLayout->addWidget(stow->graphicsView);
...
LawFunctionDialog::LawFunctionDialog() : QDialog()
{
  buildGui();
}

LawFunctionDialog::LawFunctionDialog(QWidget *parent) : QDialog(parent)
{
  buildGui();
}

LawFunctionDialog::~LawFunctionDialog()
{
  
}

void LawFunctionDialog::buildGui()
{
  lawFunctionWidget = new LawFunctionWidget(this);
  QDialogButtonBox *bb = new QDialogButtonBox(QDialogButtonBox::Ok | QDialogButtonBox::Cancel, this);
  QVBoxLayout *layout = new QVBoxLayout();
  layout->addWidget(lawFunctionWidget);
  layout->addWidget(bb);
  ...
  WidgetGeometry *filter = new WidgetGeometry(this, "dlg::LawFunctionDialog");
