...
#ifndef FTR_BOOLEAN_H
#define FTR_BOOLEAN_H

#include "feature/ftrbase.h"

namespace prj{namespace srl{namespace bls{class Boolean;}}}
...
namespace ftr
{
  namespace Boolean
  {
    ...
    public:
      ...
      const std::string& getTypeString() const override {return toString(Type::Boolean);}
      const QIcon& getIcon() const override {return icon;}
      Descriptor getDescriptor() const override {return Descriptor::Create;}
      
      void serialWrite(const boost::filesystem::path&) override;
      void serialRead(const prj::srl::bls::Boolean&);
    private:
      static QIcon icon;
      struct Stow;
