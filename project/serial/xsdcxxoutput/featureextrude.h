...
/**
 * @file
 * @brief Generated from featureextrude.xsd.
 */

#ifndef PRJ_SRL_FEATUREEXTRUDE_H
#define PRJ_SRL_FEATUREEXTRUDE_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureExtrude schema type.
     *
     * @nosubgrouping
     */
    class FeatureExtrude: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter DirectionType;
       ...
       * @name directionLabel
       *
       * @brief Accessor and modifier functions for the %directionLabel
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::PLabel DirectionLabelType;
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::IPGroup DistanceLabelType;
       ...
       * @name offsetLabel
       *
       * @brief Accessor and modifier functions for the %offsetLabel
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::IPGroup OffsetLabelType;
       ...
       * @name directionType
       *
       * @brief Accessor and modifier functions for the %directionType
       * required element.
       */
      //@{
       ...
       * @name originalMap
       *
       * @brief Accessor and modifier functions for the %originalMap
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::EvolveContainer OriginalMapType;
       ...
       */
      void
      originalMap (::std::unique_ptr< OriginalMapType > p);
       ...
       */
      FeatureExtrude (const FeatureBaseType&,
                      const PicksType&,
                      const AxisPicksType&,
                      const DirectionType&,
                      const DirectionLabelType&,
       ...
       */
      FeatureExtrude (::std::unique_ptr< FeatureBaseType >,
                      ...
                      const DirectionTypeType&,
                      ::std::unique_ptr< OriginalMapType >,
      ...
      ::xsd::cxx::tree::one< OriginalMapType > originalMap_;
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %extrude document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureExtrude&);

    /**
     * @name Serialization functions for the %extrude document root.
     */
    //@{
    ...
    extrude (::std::ostream& os,
             const ::prj::srl::FeatureExtrude& x, 
    ...
    extrude (const ::prj::srl::FeatureExtrude& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             ::xml_schema::Flags f = 0);
...
#endif // PRJ_SRL_FEATUREEXTRUDE_H
