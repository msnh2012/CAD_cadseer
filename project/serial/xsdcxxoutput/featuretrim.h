...
/**
 * @file
 * @brief Generated from featuretrim.xsd.
 */

#ifndef PRJ_SRL_FEATURETRIM_H
#define PRJ_SRL_FEATURETRIM_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureTrim schema type.
     *
     * @nosubgrouping
     */
    class FeatureTrim: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       * @name reversed
       *
       * @brief Accessor and modifier functions for the %reversed
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter ReversedType;
       ...
       * @name reversedLabel
       *
       * @brief Accessor and modifier functions for the %reversedLabel
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::PLabel ReversedLabelType;
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %trim document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureTrim&);

    /**
     * @name Serialization functions for the %trim document root.
     */
    //@{
    ...
    trim (const ::prj::srl::FeatureTrim& x, 
          const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
          ::xml_schema::Flags f = 0);
