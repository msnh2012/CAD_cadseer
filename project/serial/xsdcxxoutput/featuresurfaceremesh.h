...
/**
 * @file
 * @brief Generated from featuresurfaceremesh.xsd.
 */

#ifndef PRJ_SRL_FEATURESURFACEREMESH_H
#define PRJ_SRL_FEATURESURFACEREMESH_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureSurfaceReMesh schema type.
     *
     * @nosubgrouping
     */
    class FeatureSurfaceReMesh: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::msh::Surface MeshType;
       ...
       * @name reMeshType
       *
       * @brief Accessor and modifier functions for the %reMeshType
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter ReMeshTypeType;
       ...
       * @name minEdgeLength
       *
       * @brief Accessor and modifier functions for the %minEdgeLength
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter MinEdgeLengthType;
       ...
       * @name maxEdgeLength
       *
       * @brief Accessor and modifier functions for the %maxEdgeLength
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter MaxEdgeLengthType;
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter IterationsType;
      ...
      /**
       * @name reMeshTypeLabel
       *
       * @brief Accessor and modifier functions for the %reMeshTypeLabel
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::PLabel ReMeshTypeLabelType;
      ...
      /**
       * @name minEdgeLengthLabel
       *
       * @brief Accessor and modifier functions for the %minEdgeLengthLabel
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::PLabel MinEdgeLengthLabelType;
      ...
      /**
       * @name maxEdgeLengthLabel
       *
       * @brief Accessor and modifier functions for the %maxEdgeLengthLabel
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::PLabel MaxEdgeLengthLabelType;
       ...
       *
       * @brief Accessor and modifier functions for the %iterationsLabel
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::PLabel IterationsLabelType;
       ...
       */
      FeatureSurfaceReMesh (const FeatureBaseType&,
                            const MeshType&,
                            const ReMeshTypeType&,
                            const MinEdgeLengthType&,
                            const MaxEdgeLengthType&,
       ...
       */
      FeatureSurfaceReMesh (::std::unique_ptr< FeatureBaseType >,
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %surfaceremesh document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureSurfaceReMesh&);

    /**
     * @name Serialization functions for the %surfaceremesh document root.
     */
    //@{
    ...
    surfaceremesh (::std::ostream& os,
                   const ::prj::srl::FeatureSurfaceReMesh& x, 
    ...
    surfaceremesh (const ::prj::srl::FeatureSurfaceReMesh& x, 
                   const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                   ::xml_schema::Flags f = 0);
...
#endif // PRJ_SRL_FEATURESURFACEREMESH_H
