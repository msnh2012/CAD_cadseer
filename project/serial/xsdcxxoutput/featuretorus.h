...
/**
 * @file
 * @brief Generated from featuretorus.xsd.
 */

#ifndef PRJ_SRL_FEATURETORUS_H
#define PRJ_SRL_FEATURETORUS_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %OffsetIds schema type.
     *
     * @nosubgrouping
     */
    class OffsetIds: public ::xml_schema::Type
    {
      public:
      /**
       * @name id
    ...
    /**
     * @brief Class corresponding to the %FeatureTorus schema type.
     *
     * @nosubgrouping
     */
    class FeatureTorus: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter Radius1Type;
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::Parameter Radius2Type;
       ...
       * @name offsetIds
       *
       * @brief Accessor and modifier functions for the %offsetIds
       * required element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::prj::srl::OffsetIds OffsetIdsType;
       ...
       */
      void
      offsetIds (::std::unique_ptr< OffsetIdsType > p);
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %torus document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const OffsetIds&);

    void
    operator<< (::xercesc::DOMElement&, const FeatureTorus&);

    /**
     * @name Serialization functions for the %torus document root.
     */
    //@{
    ...
    torus (const ::prj::srl::FeatureTorus& x, 
           const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
           ::xml_schema::Flags f = 0);
