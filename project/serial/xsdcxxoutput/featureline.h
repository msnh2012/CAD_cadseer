...
/**
 * @file
 * @brief Generated from featureline.xsd.
 */

#ifndef PRJ_SRL_FEATURELINE_H
#define PRJ_SRL_FEATURELINE_H
...
namespace prj
{
  ...
  {
    /**
     * @brief Class corresponding to the %FeatureLine schema type.
     *
     * @nosubgrouping
     */
    class FeatureLine: public ::xml_schema::Type
    {
      public:
      /**
       * @name featureBase
       ...
       * @name lineId
       *
       * @brief Accessor and modifier functions for the %lineId
       * required element.
       */
      //@{
       ...
       */
      FeatureLine (const FeatureBaseType&,
                   const PicksType&,
                   const LineIdType&);
       ...
       */
      FeatureLine (::std::unique_ptr< FeatureBaseType >,
...
namespace prj
{
  ...
  {
    /**
     * @name Parsing functions for the %line document root.
     */
    //@{
...
namespace prj
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureLine&);

    /**
     * @name Serialization functions for the %line document root.
     */
    //@{
    ...
    line (const ::prj::srl::FeatureLine& x, 
          const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
          ::xml_schema::Flags f = 0);
