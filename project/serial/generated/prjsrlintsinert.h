...
#ifndef PRJ_SRL_INTS_PRJSRLINTSINERT_H
#define PRJ_SRL_INTS_PRJSRLINTSINERT_H
...
namespace prj
{
  namespace srl
  {
    namespace ints
    {
      class Inert: public ::xml_schema::Type
      {
        public:
        // base
        //
        ...
        // Constructors.
        //
        Inert (const BaseType&,
               const SeerShapeType&,
               const CsysType&,
               const CsysDraggerType&);

        Inert (::std::unique_ptr< BaseType >,
...
namespace prj
{
  namespace srl
  {
    namespace ints
    {
      ...
      ::std::unique_ptr< ::prj::srl::ints::Inert >
      inert (const ::xercesc::DOMDocument& d,
             ::xml_schema::Flags f = 0,
             const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
namespace prj
{
  namespace srl
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement&, const Inert&);

      // Serialize to std::ostream.
      //

      void
      inert (::std::ostream& os,
             const ::prj::srl::ints::Inert& x, 
      ...
      void
      inert (::xercesc::XMLFormatTarget& ft,
             const ::prj::srl::ints::Inert& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             const ::std::string& e = "UTF-8",
             ::xml_schema::Flags f = 0);
      ...
      inert (const ::prj::srl::ints::Inert& x, 
             const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
             ::xml_schema::Flags f = 0);
    }
  }
...
#endif // PRJ_SRL_INTS_PRJSRLINTSINERT_H
