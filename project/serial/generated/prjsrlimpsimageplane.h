...
#ifndef PRJ_SRL_IMPS_PRJSRLIMPSIMAGEPLANE_H
#define PRJ_SRL_IMPS_PRJSRLIMPSIMAGEPLANE_H
...
namespace prj
{
  namespace srl
  {
    namespace imps
    {
      class ImagePlane: public ::xml_schema::Type
      {
        public:
        // base
        //
        ...
        // cornerVec
        //
        typedef ::prj::srl::spt::Vec3d CornerVecType;
...
namespace prj
{
  namespace srl
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement&, const ImagePlane&);
      ...
      imageplane (::std::ostream& os,
                  const ::prj::srl::imps::ImagePlane& x, 
      ...
      imageplane (const ::prj::srl::imps::ImagePlane& x, 
                  const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
                  ::xml_schema::Flags f = 0);
    }
  }
...
#endif // PRJ_SRL_IMPS_PRJSRLIMPSIMAGEPLANE_H
