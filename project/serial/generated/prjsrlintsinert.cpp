...
namespace prj
{
  namespace srl
  {
    namespace ints
    {
      ...
      const Inert::BaseType& Inert::
      base () const
      {
        return this->base_.get ();
      }

      Inert::BaseType& Inert::
      base ()
      {
        return this->base_.get ();
      }
      ...
      const Inert::SeerShapeType& Inert::
      seerShape () const
      {
        return this->seerShape_.get ();
      }

      Inert::SeerShapeType& Inert::
      seerShape ()
      {
        return this->seerShape_.get ();
      }
      ...
      const Inert::CsysType& Inert::
      csys () const
      {
        return this->csys_.get ();
      }

      Inert::CsysType& Inert::
      csys ()
      {
        return this->csys_.get ();
      }
      ...
      const Inert::CsysDraggerType& Inert::
      csysDragger () const
      {
        return this->csysDragger_.get ();
      }

      Inert::CsysDraggerType& Inert::
      csysDragger ()
      {
        return this->csysDragger_.get ();
      }
...
namespace prj
{
  namespace srl
  {
    namespace ints
    {
      ...
      Inert::
      Inert (::std::unique_ptr< BaseType > base,
      ...
      Inert::
      Inert (const ::xercesc::DOMElement& e,
             ::xml_schema::Flags f,
             ::xml_schema::Container* c)
      ...
      {
        return new class Inert (*this, f, c);
      }

      Inert& Inert::
      operator= (const Inert& x)
      {
        if (this != &x)
        {
...
namespace prj
{
  namespace srl
  {
    namespace ints
    {
      ::std::unique_ptr< ::prj::srl::ints::Inert >
             ...
             const ::xml_schema::Properties& p)
      {
        ...
        return ::std::unique_ptr< ::prj::srl::ints::Inert > (
          ::prj::srl::ints::inert (
             ...
             const ::xml_schema::Properties& p)
      {
        ...
        return ::prj::srl::ints::inert (isrc, f, p);
      }
             ...
             const ::xml_schema::Properties& p)
      {
        ...
        ::xsd::cxx::xml::sax::std_input_source isrc (is);
        return ::prj::srl::ints::inert (isrc, h, f, p);
      }
             ...
             const ::xml_schema::Properties& p)
      {
        ...
        if (n.name () == "inert" &&
            n.namespace_ () == "http://www.cadseer.com/prj/srl/ints")
        {
          ::std::unique_ptr< ::prj::srl::ints::Inert > r (
            ::xsd::cxx::tree::traits< ::prj::srl::ints::Inert, char >::create (
              e, f, 0));
          return r;
        }
        ...
        throw ::xsd::cxx::tree::unexpected_element < char > (
          ...
          n.namespace_ (),
          "inert",
          "http://www.cadseer.com/prj/srl/ints");
      }
...
namespace prj
{
  namespace srl
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement& e, const Inert& i)
      {
      ...
      inert (const ::prj::srl::ints::Inert& s,
             const ::xml_schema::NamespaceInfomap& m,
             ::xml_schema::Flags f)
      {
        ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
