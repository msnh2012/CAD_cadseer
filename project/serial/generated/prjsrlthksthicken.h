...
#ifndef PRJ_SRL_THKS_PRJSRLTHKSTHICKEN_H
#define PRJ_SRL_THKS_PRJSRLTHKSTHICKEN_H
...
namespace prj
{
  namespace srl
  {
    namespace thks
    {
      class Thicken: public ::xml_schema::Type
      {
        public:
        // base
        //
        ...
        // faceMap
        //
        typedef ::prj::srl::spt::EvolveRecord FaceMapType;
        typedef ::xsd::cxx::tree::sequence< FaceMapType > FaceMapSequence;
        typedef FaceMapSequence::iterator FaceMapIterator;
        typedef FaceMapSequence::const_iterator FaceMapConstIterator;
        typedef ::xsd::cxx::tree::traits< FaceMapType, char > FaceMapTraits;

        const FaceMapSequence&
        faceMap () const;
        ...
        // edgeMap
        //
        typedef ::prj::srl::spt::EvolveRecord EdgeMapType;
        typedef ::xsd::cxx::tree::sequence< EdgeMapType > EdgeMapSequence;
        typedef EdgeMapSequence::iterator EdgeMapIterator;
        typedef EdgeMapSequence::const_iterator EdgeMapConstIterator;
        typedef ::xsd::cxx::tree::traits< EdgeMapType, char > EdgeMapTraits;

        const EdgeMapSequence&
        edgeMap () const;
        ...
        // boundaryMap
        //
        typedef ::prj::srl::spt::EvolveRecord BoundaryMapType;
        typedef ::xsd::cxx::tree::sequence< BoundaryMapType > BoundaryMapSequence;
        typedef BoundaryMapSequence::iterator BoundaryMapIterator;
        typedef BoundaryMapSequence::const_iterator BoundaryMapConstIterator;
        typedef ::xsd::cxx::tree::traits< BoundaryMapType, char > BoundaryMapTraits;

        const BoundaryMapSequence&
        boundaryMap () const;
...
namespace prj
{
  namespace srl
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement&, const Thicken&);
      ...
      thicken (const ::prj::srl::thks::Thicken& x, 
               const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
               ::xml_schema::Flags f = 0);
    }
  }
...
#endif // PRJ_SRL_THKS_PRJSRLTHKSTHICKEN_H
