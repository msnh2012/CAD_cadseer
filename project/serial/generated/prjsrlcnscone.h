...
#ifndef PRJ_SRL_CNS_PRJSRLCNSCONE_H
#define PRJ_SRL_CNS_PRJSRLCNSCONE_H
...
namespace prj
{
  namespace srl
  {
    namespace cns
    {
      ...
      ::std::unique_ptr< ::prj::srl::cns::Cone >
      cone (const ::xercesc::DOMDocument& d,
            ::xml_schema::Flags f = 0,
            const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
namespace prj
{
  namespace srl
  {
    namespace cns
    {
      ...
      void
      cone (::xercesc::XMLFormatTarget& ft,
            const ::prj::srl::cns::Cone& x, 
            const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::Flags f = 0);
...
#endif // PRJ_SRL_CNS_PRJSRLCNSCONE_H
