...
namespace prj
{
  namespace srl
  {
    namespace unns
    {
      ...
      const Union::SeerShapeType& Union::
      seerShape () const
      {
        return this->seerShape_.get ();
      }

      Union::SeerShapeType& Union::
      seerShape ()
      {
        return this->seerShape_.get ();
      }
      ...
      const Union::IntersectionMapperType& Union::
      intersectionMapper () const
      {
        return this->intersectionMapper_.get ();
      }

      Union::IntersectionMapperType& Union::
      intersectionMapper ()
      {
        return this->intersectionMapper_.get ();
      }
      ...
      const Union::TargetPicksSequence& Union::
      targetPicks () const
      {
        return this->targetPicks_;
      }

      Union::TargetPicksSequence& Union::
      targetPicks ()
      {
        return this->targetPicks_;
      }
      ...
      const Union::ToolPicksSequence& Union::
      toolPicks () const
      {
        return this->toolPicks_;
      }

      Union::ToolPicksSequence& Union::
      toolPicks ()
      {
        return this->toolPicks_;
      }
...
namespace prj
{
  namespace srl
  {
    namespace unns
    {
      ...
      Union::
      Union (::std::unique_ptr< BaseType > base,
      ...
      {
        return new class Union (*this, f, c);
      }
  ...
  namespace srl
  {
    namespace unns
    {
              ...
              const ::xml_schema::Properties& p)
      {
        ...
        return ::std::unique_ptr< ::prj::srl::unns::Union > (
          ::prj::srl::unns::fUnion (
              ...
              const ::xml_schema::Properties& p)
      {
        ...
        return ::prj::srl::unns::fUnion (isrc, f, p);
      }
              ...
              const ::xml_schema::Properties& p)
      {
        ...
        ::xsd::cxx::xml::sax::std_input_source isrc (is);
        return ::prj::srl::unns::fUnion (isrc, h, f, p);
      }
              ...
              const ::xml_schema::Properties& p)
      {
        ...
        if (n.name () == "fUnion" &&
            n.namespace_ () == "http://www.cadseer.com/prj/srl/unns")
        {
          ::std::unique_ptr< ::prj::srl::unns::Union > r (
            ::xsd::cxx::tree::traits< ::prj::srl::unns::Union, char >::create (
              e, f, 0));
          return r;
        }
        ...
        throw ::xsd::cxx::tree::unexpected_element < char > (
          ...
          n.namespace_ (),
          "fUnion",
          "http://www.cadseer.com/prj/srl/unns");
      }
...
namespace prj
{
  namespace srl
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement& e, const Union& i)
      {
        ...
        // targetPicks
        //
        for (Union::TargetPicksConstIterator
        ...
        // toolPicks
        //
        for (Union::ToolPicksConstIterator
      ...
      fUnion (const ::prj::srl::unns::Union& s,
              const ::xml_schema::NamespaceInfomap& m,
              ::xml_schema::Flags f)
      {
        ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
