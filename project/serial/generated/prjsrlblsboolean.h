...
#ifndef PRJ_SRL_BLS_PRJSRLBLSBOOLEAN_H
#define PRJ_SRL_BLS_PRJSRLBLSBOOLEAN_H
  ...
  namespace srl
  {
    namespace bls
    {
      class Boolean: public ::xml_schema::Type
      {
        ...
        // booleanType
        //
        typedef ::prj::srl::spt::Parameter BooleanTypeType;
        typedef ::xsd::cxx::tree::traits< BooleanTypeType, char > BooleanTypeTraits;
...
namespace prj
{
  namespace srl
  {
    namespace bls
    {
      ...
      ::std::unique_ptr< ::prj::srl::bls::Boolean >
      boolean (::xercesc::InputSource& is,
               ::xml_schema::Flags f = 0,
               const ::xml_schema::Properties& p = ::xml_schema::Properties ());
      ...
      ::std::unique_ptr< ::prj::srl::bls::Boolean >
      boolean (const ::xercesc::DOMDocument& d,
               ::xml_schema::Flags f = 0,
               const ::xml_schema::Properties& p = ::xml_schema::Properties ());
...
namespace prj
{
  namespace srl
  {
    namespace bls
    {
      ...
      void
      boolean (::std::ostream& os,
               const ::prj::srl::bls::Boolean& x, 
      ...
      void
      boolean (::xercesc::XMLFormatTarget& ft,
               const ::prj::srl::bls::Boolean& x, 
               const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
               const ::std::string& e = "UTF-8",
               ::xml_schema::Flags f = 0);
      ...
      boolean (const ::prj::srl::bls::Boolean& x, 
               const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
               ::xml_schema::Flags f = 0);
    }
  }
...
#endif // PRJ_SRL_BLS_PRJSRLBLSBOOLEAN_H
