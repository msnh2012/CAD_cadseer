...
#ifndef PRJ_SRL_EXTS_PRJSRLEXTSEXTRACT_H
#define PRJ_SRL_EXTS_PRJSRLEXTSEXTRACT_H
...
namespace prj
{
  namespace srl
  {
    namespace exts
    {
      class Extract: public ::xml_schema::Type
      {
        public:
        // base
        //
...
namespace prj
{
  namespace srl
  {
    ...
    {
      void
      operator<< (::xercesc::DOMElement&, const Extract&);
      ...
      extract (const ::prj::srl::exts::Extract& x, 
               const ::xml_schema::NamespaceInfomap& m = ::xml_schema::NamespaceInfomap (),
               ::xml_schema::Flags f = 0);
    }
  }
...
#endif // PRJ_SRL_EXTS_PRJSRLEXTSEXTRACT_H
