...
namespace prj
{
  namespace srl
  {
    namespace mshs
    {
      ...
      const ParametersGMSH::OptionsSequence& ParametersGMSH::
      options () const
      {
        return this->options_;
      }

      ParametersGMSH::OptionsSequence& ParametersGMSH::
      options ()
      {
        return this->options_;
      }
      ...
      const Face::IndexesSequence& Face::
      indexes () const
      {
        return this->indexes_;
      }

      Face::IndexesSequence& Face::
      indexes ()
      {
        return this->indexes_;
      }
      ...
      const Surface::PointsSequence& Surface::
      points () const
      {
        return this->points_;
      }

      Surface::PointsSequence& Surface::
      points ()
      {
        return this->points_;
      }
      ...
      const Surface::FacesSequence& Surface::
      faces () const
      {
        return this->faces_;
      }

      Surface::FacesSequence& Surface::
      faces ()
      {
        return this->faces_;
      }
...
namespace prj
{
  namespace srl
  {
    namespace mshs
    {
      ...
      ParametersGMSH::
      ParametersGMSH (const RefineType& refine)
      : ::xml_schema::Type (),
        options_ (this),
        refine_ (refine, this)
      {
             ...
             ::xml_schema::Flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          if (n.name () == "options" && n.namespace_ ().empty ())
          {
            ...
            this->options_.push_back (::std::move (r));
            continue;
          }
             ...
             ::xml_schema::Flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          {
            this->indexes_.push_back (IndexesTraits::create (i, f, this));
            continue;
          }
             ...
             ::xml_schema::Flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          if (n.name () == "points" && n.namespace_ ().empty ())
          {
            ...
            this->points_.push_back (::std::move (r));
            continue;
          }
          ...
          if (n.name () == "faces" && n.namespace_ ().empty ())
          {
            ...
            this->faces_.push_back (::std::move (r));
            continue;
          }
  ...
  namespace srl
  {
    namespace mshs
    {
      ...
      operator<< (::xercesc::DOMElement& e, const ParametersGMSH& i)
      {
        ...
        // options
        //
        for (ParametersGMSH::OptionsConstIterator
             b (i.options ().begin ()), n (i.options ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
      ...
      operator<< (::xercesc::DOMElement& e, const Face& i)
      {
        ...
        // indexes
        //
        for (Face::IndexesConstIterator
             b (i.indexes ().begin ()), n (i.indexes ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
      ...
      operator<< (::xercesc::DOMElement& e, const Surface& i)
      {
        ...
        // points
        //
        for (Surface::PointsConstIterator
        ...
        // faces
        //
        for (Surface::FacesConstIterator
             b (i.faces ().begin ()), n (i.faces ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
