...
namespace prj
{
  namespace srl
  {
    namespace vws
    {
      ...
      const View::StatesSequence& View::
      states () const
      {
        return this->states_;
      }

      View::StatesSequence& View::
      states ()
      {
        return this->states_;
      }
...
namespace prj
{
  namespace srl
  {
    namespace vws
    {
      ...
      View::
      View (::std::unique_ptr< CsysType > csys)
      : ::xml_schema::Type (),
        states_ (this),
  ...
  namespace srl
  {
    namespace vws
    {
            ...
            const ::xml_schema::Properties& p)
      {
        ...
        return ::std::unique_ptr< ::prj::srl::vws::View > (
          ::prj::srl::vws::view (
            ...
            const ::xml_schema::Properties& p)
      {
        ...
        return ::prj::srl::vws::view (isrc, f, p);
      }
            ...
            const ::xml_schema::Properties& p)
      {
        ...
        ::xsd::cxx::xml::sax::std_input_source isrc (is);
        return ::prj::srl::vws::view (isrc, h, f, p);
      }
            ...
            const ::xml_schema::Properties& p)
      {
        ...
        if (n.name () == "view" &&
            n.namespace_ () == "http://www.cadseer.com/prj/srl/vws")
        {
          ::std::unique_ptr< ::prj::srl::vws::View > r (
            ::xsd::cxx::tree::traits< ::prj::srl::vws::View, char >::create (
              e, f, 0));
          return r;
        }
        ...
        throw ::xsd::cxx::tree::unexpected_element < char > (
          ...
          n.namespace_ (),
          "view",
          "http://www.cadseer.com/prj/srl/vws");
      }
