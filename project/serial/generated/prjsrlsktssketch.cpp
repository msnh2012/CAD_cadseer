...
namespace prj
{
  namespace srl
  {
    namespace skts
    {
      ...
      const SSEntity::PointsSequence& SSEntity::
      points () const
      {
        return this->points_;
      }

      SSEntity::PointsSequence& SSEntity::
      points ()
      {
        return this->points_;
      }
      ...
      const SSEntity::ParametersSequence& SSEntity::
      parameters () const
      {
        return this->parameters_;
      }

      SSEntity::ParametersSequence& SSEntity::
      parameters ()
      {
        return this->parameters_;
      }
      ...
      const Solver::ParametersSequence& Solver::
      parameters () const
      {
        return this->parameters_;
      }

      Solver::ParametersSequence& Solver::
      parameters ()
      {
        return this->parameters_;
      }
      ...
      const Solver::EntitiesSequence& Solver::
      entities () const
      {
        return this->entities_;
      }

      Solver::EntitiesSequence& Solver::
      entities ()
      {
        return this->entities_;
      }
      ...
      const Solver::ConstraintsSequence& Solver::
      constraints () const
      {
        return this->constraints_;
      }

      Solver::ConstraintsSequence& Solver::
      constraints ()
      {
        return this->constraints_;
      }
      ...
      const Visual::EntityMapSequence& Visual::
      entityMap () const
      {
        return this->entityMap_;
      }

      Visual::EntityMapSequence& Visual::
      entityMap ()
      {
        return this->entityMap_;
      }
      ...
      const Visual::ConstraintMapSequence& Visual::
      constraintMap () const
      {
        return this->constraintMap_;
      }

      Visual::ConstraintMapSequence& Visual::
      constraintMap ()
      {
        return this->constraintMap_;
      }
      ...
      const Sketch::BaseType& Sketch::
      base () const
      {
        return this->base_.get ();
      }

      Sketch::BaseType& Sketch::
      base ()
      {
        return this->base_.get ();
      }
      ...
      const Sketch::SeerShapeType& Sketch::
      seerShape () const
      {
        return this->seerShape_.get ();
      }

      Sketch::SeerShapeType& Sketch::
      seerShape ()
      {
        return this->seerShape_.get ();
      }
      ...
      const Sketch::SolverType& Sketch::
      solver () const
      {
        return this->solver_.get ();
      }

      Sketch::SolverType& Sketch::
      solver ()
      {
        return this->solver_.get ();
      }
      ...
      const Sketch::VisualType& Sketch::
      visual () const
      {
        return this->visual_.get ();
      }

      Sketch::VisualType& Sketch::
      visual ()
      {
        return this->visual_.get ();
      }
      ...
      const Sketch::WireIdsSequence& Sketch::
      wireIds () const
      {
        return this->wireIds_;
      }

      Sketch::WireIdsSequence& Sketch::
      wireIds ()
      {
        return this->wireIds_;
      }
      ...
      const Sketch::HandleParameterPairsSequence& Sketch::
      handleParameterPairs () const
      {
        return this->handleParameterPairs_;
      }

      Sketch::HandleParameterPairsSequence& Sketch::
    ...
    namespace skts
    {
             ...
             ::xml_schema::Flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          {
            this->points_.push_back (PointsTraits::create (i, f, this));
            continue;
          }
          ...
          {
            this->parameters_.push_back (ParametersTraits::create (i, f, this));
            continue;
          }
      ...
      Solver::
      Solver (const NextParameterHandleType& nextParameterHandle,
             ...
             ::xml_schema::Flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          if (n.name () == "parameters" && n.namespace_ ().empty ())
          {
            ...
            this->parameters_.push_back (::std::move (r));
            continue;
          }
          ...
          if (n.name () == "entities" && n.namespace_ ().empty ())
          {
            ...
            this->entities_.push_back (::std::move (r));
            continue;
          }
          ...
          if (n.name () == "constraints" && n.namespace_ ().empty ())
          {
            ...
            this->constraints_.push_back (::std::move (r));
            continue;
          }
             ...
             ::xml_schema::Flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          if (n.name () == "entityMap" && n.namespace_ ().empty ())
          {
            ...
            this->entityMap_.push_back (::std::move (r));
            continue;
          }
          ...
          if (n.name () == "constraintMap" && n.namespace_ ().empty ())
          {
            ...
            this->constraintMap_.push_back (::std::move (r));
            continue;
          }
      ...
      Sketch::
      Sketch (::std::unique_ptr< BaseType > base,
             ...
             ::xml_schema::Flags f)
      {
        for (; p.more_content (); p.next_content (false))
        {
          ...
          if (n.name () == "handleParameterPairs" && n.namespace_ ().empty ())
          {
            ...
            this->handleParameterPairs_.push_back (::std::move (r));
            continue;
          }
      ...
      _clone (::xml_schema::Flags f,
              ::xml_schema::Container* c) const
      {
        return new class Sketch (*this, f, c);
      }
  ...
  namespace srl
  {
    namespace skts
    {
              ...
              const ::xml_schema::Properties& p)
      {
        ...
        return ::std::unique_ptr< ::prj::srl::skts::Sketch > (
          ::prj::srl::skts::sketch (
              ...
              const ::xml_schema::Properties& p)
      {
        ...
        return ::prj::srl::skts::sketch (isrc, f, p);
      }
              ...
              const ::xml_schema::Properties& p)
      {
        ...
        ::xsd::cxx::xml::sax::std_input_source isrc (is);
        return ::prj::srl::skts::sketch (isrc, h, f, p);
      }
              ...
              const ::xml_schema::Properties& p)
      {
        ...
        if (n.name () == "sketch" &&
            n.namespace_ () == "http://www.cadseer.com/prj/srl/skts")
        {
          ::std::unique_ptr< ::prj::srl::skts::Sketch > r (
            ::xsd::cxx::tree::traits< ::prj::srl::skts::Sketch, char >::create (
              e, f, 0));
          return r;
        }
        ...
        throw ::xsd::cxx::tree::unexpected_element < char > (
          ...
          n.namespace_ (),
          "sketch",
          "http://www.cadseer.com/prj/srl/skts");
      }
  ...
  namespace srl
  {
    namespace skts
    {
      ...
      operator<< (::xercesc::DOMElement& e, const SSEntity& i)
      {
        ...
        // points
        //
        for (SSEntity::PointsConstIterator
             b (i.points ().begin ()), n (i.points ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
        ...
        // parameters
        //
        for (SSEntity::ParametersConstIterator
      ...
      operator<< (::xercesc::DOMElement& e, const Solver& i)
      {
        ...
        // parameters
        //
        for (Solver::ParametersConstIterator
             b (i.parameters ().begin ()), n (i.parameters ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
        ...
        // entities
        //
        for (Solver::EntitiesConstIterator
        ...
        // constraints
        //
        for (Solver::ConstraintsConstIterator
             b (i.constraints ().begin ()), n (i.constraints ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
      ...
      operator<< (::xercesc::DOMElement& e, const Visual& i)
      {
        ...
        // entityMap
        //
        for (Visual::EntityMapConstIterator
             b (i.entityMap ().begin ()), n (i.entityMap ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
        ...
        // constraintMap
        //
        for (Visual::ConstraintMapConstIterator
             b (i.constraintMap ().begin ()), n (i.constraintMap ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
      ...
      void
      operator<< (::xercesc::DOMElement& e, const Sketch& i)
      {
        e << static_cast< const ::xml_schema::Type& > (i);
        ...
        // wireIds
        //
        for (Sketch::WireIdsConstIterator
        ...
        // handleParameterPairs
        //
        for (Sketch::HandleParameterPairsConstIterator
             b (i.handleParameterPairs ().begin ()), n (i.handleParameterPairs ().end ());
             b != n; ++b)
        {
          ::xercesc::DOMElement& s (
            ::xsd::cxx::xml::dom::create_element (
      ...
      sketch (const ::prj::srl::skts::Sketch& s,
              const ::xml_schema::NamespaceInfomap& m,
              ::xml_schema::Flags f)
      {
        ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
