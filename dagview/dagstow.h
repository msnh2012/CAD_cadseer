...
namespace dag
{
  namespace qtd
  {
    ...
    const static int selectableIcon =   5;
    const static int stateIcon =        6;
    const static int featureIcon =      7;
    const static int text =             8;
  ...
  */
  ...
  public:
    ...
    Vertex findSelectableVertex(const QGraphicsPixmapItem*);
